...
void loop() {
   ...
   digitalWrite(6, LOW);       // zhasnutí diody

   delay(500);

   digitalWrite(7, LOW);       // zhasnutí diody

   delay(500);

   digitalWrite(8, LOW);       // zhasnutí diody 

   delay(500);

   digitalWrite(9, LOW);       // zhasnutí diody

   delay(500);

   digitalWrite(10, LOW);      // zhasnutí diody

   delay(500);

   digitalWrite(11, LOW);      // zhasnutí diody

   delay(500);

   digitalWrite(12, LOW);      // zhasnutí diody 
